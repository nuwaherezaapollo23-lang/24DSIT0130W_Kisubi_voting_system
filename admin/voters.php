...
if(isset($_POST['add_voter'])){
    ...
    mysqli_query($conn, "INSERT INTO voters(reg_no,name,gender,email,password) VALUES('$reg_no','$name','$gender','$email','$password')");
...
if(isset($_POST['update_voter'])){
    ...
    $gender = $_POST['gender'];
    $email = $_POST['email'];
    mysqli_query($conn, "UPDATE voters SET reg_no='$reg_no', name='$name', gender='$gender', email='$email' WHERE voter_id=$id");
    header("Location: voters.php");
}
...
if(isset($_GET['delete'])){
    $id = $_GET['delete'];
    mysqli_query($conn, "DELETE FROM voters WHERE voter_id=$id");
    header("Location: voters.php");
}
?>
